                ...
                <div>
                    ...
                    {(showProblem && 
                        <div className={styles.problem}>
                            <div className={styles.name}>{problemData.name}</div>
                            <div className={styles.statement}>{problemData.statement}</div>
                            <div className={styles.inputOutput1}>
                                <span>Input</span>
                                <div>{problemData.SampleInput}</div>
                                <span>Output</span>
                                <div>{problemData.SampleOutput}</div>
                            </div>
                        </div>
                    )}
